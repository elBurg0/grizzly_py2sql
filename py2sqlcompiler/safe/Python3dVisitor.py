...
class Python3dVisitor(ParseTreeVisitor):
    ...
    def visitSmall_stmt(self, ctx: Python3dParser.Small_stmtContext):
     ...
     # Visit a parse tree produced by Python3dParser#grizzly_stmt.
    def visitGrizzly_stmt(self, ctx:Python3dParser.Grizzly_stmtContext):
        print("GRIZZLY STATEMENT: " + ctx.getText())
    ...
    # Visit a parse tree produced by Python3dParser#grizzly_assignment.
    def visitGrizzly_assignment(self, ctx:Python3dParser.Grizzly_assignmentContext):
        print("GRIZZLY ASSIGNMENT: " + ctx.getText())
        self.to_eval.append(ctx.getText())
        return self.visitChildren(ctx)
