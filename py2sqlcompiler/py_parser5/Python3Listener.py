...
class Python3Listener(ParseTreeListener):
    ...
    # Enter a parse tree produced by Python3Parser#db_reference.
    def enterDb_reference(self, ctx:Python3Parser.Db_referenceContext):
        pass

    # Exit a parse tree produced by Python3Parser#db_reference.
    def exitDb_reference(self, ctx:Python3Parser.Db_referenceContext):
        pass
