...
class Python3Listener(ParseTreeListener):
    ...
    def enterCondition(self, ctx:Python3Parser.TestContext):
        pass

    # Exit a parse tree produced by Python3Parser#condition.
    def exitCondition(self, ctx:Python3Parser.TestContext):
        pass
    ...
    def enterRange(self, ctx:Python3Parser.RangContext):
        pass

    # Exit a parse tree produced by Python3Parser#range.
    def exitRange(self, ctx:Python3Parser.RangContext):
        pass


    # Enter a parse tree produced by Python3Parser#list.
    def enterList(self, ctx:Python3Parser.LisContext):
        pass

    # Exit a parse tree produced by Python3Parser#list.
    def exitList(self, ctx:Python3Parser.LisContext):
        pass


    # Enter a parse tree produced by Python3Parser#comprehension.
    def enterComprehension(self, ctx:Python3Parser.Comp_opContext):
        pass

    # Exit a parse tree produced by Python3Parser#comprehension.
    def exitComprehension(self, ctx:Python3Parser.Comp_opContext):
        pass
